...
public  class GuitarraElectrica extends Guitarra{
    ...
    public  GuitarraElectrica(String serial,String color,int NumeroDeCuerdas ,String TipoDeMadera,boolean microfono,String TipoDeCuerpo,boolean cajaDeResonancia,String tipodeCuerdas, boolean ConexionARedElectrica,boolean pastillas) {
